const ITEMS = [
  ...
  },
  {
    ...
    a: "Mekanbahis, Curaçao eGaming lisansı altında 256-bit SSL şifreleme ile hizmet verir. Tüm kullanıcı verileri ve ödemeler uçtan uca korunur.",
  },
];
          ...
          {ITEMS.map((item, i) => (
            ...
            >
              ...
              <div className="px-5 pb-5 sm:px-6">
                <p className="text-[15px] leading-7 text-[#cfc6ef]">{item.a}</p>
              </div>
            </details>
          ))}
        </div>
