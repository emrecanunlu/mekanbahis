...
export function FloatingCta() {
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-3 z-40 flex justify-center px-4 sm:bottom-5">
      <div className="pointer-events-auto inline-flex items-center gap-2 rounded-full bg-[#1a0d3d]/90 p-1.5 shadow-[0_10px_30px_-8px_rgba(0,0,0,0.6)] ring-1 ring-pink/20 backdrop-blur">
        <a
          href={SITE.registerUrl}
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex h-10 cursor-pointer items-center gap-2 rounded-full bg-gradient-to-r from-pink-500 to-fuchsia-600 px-4 text-sm font-semibold text-white transition-transform hover:from-pink-400 hover:to-fuchsia-500 active:translate-y-px sm:px-5"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
          ...
          <span className="hidden sm:inline">Mekanbahis Üye Ol</span>
