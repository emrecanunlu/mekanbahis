...
export function PartnerSites({
  ...
  return (
    <section className="border-b border-soft bg-[#0a0420]" aria-labelledby="partner-heading">
            ...
            <li key={p.slug}>
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  ...
                  {p.badge && (
                    <span className="shrink-0 rounded-full border border-pink/30 bg-pink/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-[#ff7ab8]">
                      {p.badge}
                    </span>
                  )}
                </div>
                <p className="mt-2 flex-1 text-sm leading-6 text-[#b0a7d6]">
                  {p.description}
                </p>
