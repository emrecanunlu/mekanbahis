          ...
          <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 sm:py-12">
            ...
            <div className="grid items-center gap-8 lg:grid-cols-[1.1fr_1fr]">
              <div>
                ...
                <p className="mt-2 text-sm font-medium text-[#b0a7d6]">
                  {game.subtitle}
                </p>
                <p className="mt-5 text-[15px] leading-7 text-[#cfc6ef]">
                  {game.intro}
                </p>
                <div className="mt-6 flex flex-wrap gap-3">
                  <a
                    ...
                    className="inline-flex h-12 cursor-pointer items-center gap-2 rounded-md bg-gradient-to-r from-pink-500 to-fuchsia-600 px-6 text-sm font-semibold text-white shadow-[0_10px_30px_-10px_rgba(232,62,140,0.6)] transition-transform hover:from-pink-400 hover:to-fuchsia-500 active:translate-y-px"
                  >
                    Hemen Üye Ol
                    <svg
                      viewBox="0 0 24 24"
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex h-12 cursor-pointer items-center gap-2 rounded-md border border-[#22d3ee]/40 bg-[#22d3ee]/10 px-5 text-sm font-semibold text-[#7dd3fc] transition-colors hover:bg-[#22d3ee]/20"
                  >
                    <TelegramIcon />
                    Telegram
                  </a>
              ...
              <div className="relative aspect-[16/10] overflow-hidden rounded-3xl border border-soft">
                ...
                />
                <span className="absolute inset-x-0 bottom-0 h-1/3 bg-gradient-to-t from-[#0a0420]/70 to-transparent" />
              </div>
            </div>
          </div>
        </section>
              ...
              <div className="space-y-12">
                <article>
                  ...
                  <ul className="mt-5 grid gap-2.5 sm:grid-cols-2">
                    {game.highlights.map((h) => (
                      <li
                        key={h}
                        className="flex gap-2.5 rounded-xl border border-soft bg-surface p-4 text-sm leading-6 text-[#cfc6ef]"
                      >
                  ...
                  <ul className="mt-5 grid gap-3 sm:grid-cols-2">
                    {game.popular.map((p) => (
                      ...
                      >
                        ...
                        <p className="mt-1 text-sm leading-5 text-[#b0a7d6]">
                          {p.desc}
                        </p>
                      </li>
                    ))}
                ...
                <article>
                  ...
                  <ul className="mt-4 flex flex-wrap gap-2">
                    {game.providers.map((p) => (
                      <li
                        key={p}
                        className="rounded-full border border-soft bg-surface px-3.5 py-1.5 text-sm text-[#cfc6ef]"
                      >
                        {p}
                      </li>
                    ))}
                      ...
                      {game.faq.map((item, i) => (
                        ...
                        >
                          ...
                          <div className="px-5 pb-5">
                            <p className="text-sm leading-7 text-[#cfc6ef]">
                              {item.a}
                            </p>
                          </div>
                        </details>
                ...
                <div className="rounded-2xl border border-pink/30 bg-gradient-to-br from-pink/[0.08] to-violet-500/[0.05] p-6">
                  ...
                  <p className="mt-2 text-sm leading-6 text-[#cfc6ef]">
                    Mekanbahis&apos;e üye ol, %100 hoş geldin bonusunu al ve
                  ...
                  <div className="mt-4 flex flex-wrap gap-3">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex h-11 cursor-pointer items-center gap-2 rounded-md border border-[#22d3ee]/40 bg-[#22d3ee]/10 px-5 text-sm font-semibold text-[#7dd3fc] transition-colors hover:bg-[#22d3ee]/20"
                    >
                      <TelegramIcon />
                      Telegram&apos;a Katıl
                    </a>
                  ...
                  <li key={o.slug}>
                    ...
                    >
                      <div className="relative aspect-[16/10] overflow-hidden">
                        ...
                        />
                        <span className="absolute inset-x-0 bottom-0 h-2/3 bg-gradient-to-t from-[#120831] via-[#120831]/60 to-transparent" />
                      </div>
                      <div className="p-4">
                        <h3 className="font-display text-base font-bold text-white transition-colors group-hover:text-pink">
                          {o.title}
                        </h3>
                        <p className="mt-1 text-xs text-[#b0a7d6]">
                          {o.subtitle}
                        </p>
                      </div>
                    </Link>
