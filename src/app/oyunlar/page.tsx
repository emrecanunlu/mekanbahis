...
export const metadata: Metadata = buildMetadata({
  title: "Mekanbahis Oyunlar 2026 | Canlı Bahis, Casino, Slot, Aviator",
  description:
    "Mekanbahis oyun kategorileri: canlı spor bahisleri, canlı casino, 5000+ slot, Aviator crash, sanal bahis ve e-spor. Yüksek oran, Türkçe krupiye, demo mod.",
  path: "/oyunlar",
                  ...
                  <li key={g.slug}>
                    ...
                    >
                      ...
                      <div className="p-5">
                        ...
                        <p className="mt-3 text-sm leading-6 text-[#cfc6ef]">
                          {g.short}
                        </p>
