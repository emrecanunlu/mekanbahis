      ...
      <main className="flex-1">
        <section className="border-b border-soft">
          <div className="mx-auto max-w-6xl px-4 py-10 sm:px-6 sm:py-14">
            ...
            <p className="mt-3 text-xs text-[#7e76a8]">
                      ...
                      {page.faq.map((item, i) => (
                        ...
                        >
                          ...
                          <div className="px-5 pb-5">
                            <p className="text-sm leading-7 text-[#cfc6ef]">{item.a}</p>
                          </div>
                        </details>
                      ))}
                    </div>
            ...
            <ul className="mt-6 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
              {related.map((r) => (
                <li key={r.slug}>
                  <Link
                    href={`/rehber/${r.slug}`}
                    className="block rounded-xl border border-soft bg-surface p-4 text-sm font-medium text-[#cfc6ef] transition-colors hover:border-pink/40 hover:text-pink"
                  >
                    {r.h1}
                  </Link>
                </li>
