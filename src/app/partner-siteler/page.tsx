...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Mekanbahis partner ve önerilen bahis siteleri listesi. Güvenilir, lisanslı platformlar — güncel giriş, bonus ve casino rehberleri.",
  path: "/partner-siteler",
  keywords: ["bahis siteleri", "partner siteler", "güvenilir bahis", "Mekanbahis partner"],
});
...
export default function PartnerPage() {
  ...
  const itemListJsonLd = {
    ...
    description: "Mekanbahis partner ve backlink siteleri",
            ...
            <div className="grid gap-10 lg:grid-cols-[1fr_300px]">
              <article className="prose-mb max-w-none">
                ...
                <p>
                  ...
                  çıkarılmıştır. <strong>Mekanbahis</strong> resmi sitesi listenin
