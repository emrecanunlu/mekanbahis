          ...
          <div className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
            <div className="grid gap-10 lg:grid-cols-[1fr_340px]">
              <div className="rounded-2xl border border-soft bg-surface p-6 sm:p-8">
                ...
                <p className="mt-2 text-sm leading-6 text-[#b0a7d6]">
                    ...
                    <div className="flex items-start gap-4">
                      <span
                        className={`grid h-11 w-11 shrink-0 place-items-center rounded-xl ${
                          c.accent === "cyan"
                            ? "border border-[#22d3ee]/40 bg-[#22d3ee]/10 text-[#7dd3fc]"
                            : c.accent === "violet"
                              ? "border border-violet/40 bg-violet/10 text-violet"
                              : "border border-pink/30 bg-pink/10 text-[#ff7ab8]"
                        }`}
                      >
                        {c.icon}
                      </span>
                      <div className="min-w-0">
                        ...
                        <span className="mt-2 inline-flex items-center gap-1 text-xs font-semibold text-pink transition-colors group-hover:text-[#ff7ab8]">
                          {c.label}
                          <svg
                            viewBox="0 0 24 24"
                            fill="none"
...
function Row({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-center justify-between gap-3">
      <dt className="text-[#b0a7d6]">{label}</dt>
