...
const DEFAULT_OG = "/images/mekanbahis.png";
...
export function organizationJsonLd() {
  return {
    ...
    name: SITE.name,
    url: absoluteUrl(),
    logo: absoluteUrl("/images/mekanbahis.png"),
...
export function websiteJsonLd() {
  return {
    ...
    url: absoluteUrl(),
    description:
      "Mekanbahis resmi tanıtım sitesi. Güncel giriş, bonuslar, oyun rehberleri ve partner siteler.",
...
export function articleJsonLd(opts: {
  ...
  return {
    ...
    publisher: {
      "@type": "Organization",
      name: SITE.name,
      logo: { "@type": "ImageObject", url: absoluteUrl("/images/mekanbahis.png") },
    },
    inLanguage: SITE.language,
  };
}
